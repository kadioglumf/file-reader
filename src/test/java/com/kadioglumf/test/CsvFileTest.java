...
import com.kadioglumf.dto.TestCsvDto;
...
public class CsvFileTest {
    ...
    public void shouldGetExcelDtoList() {
        try {
            ...
            List<TestCsvDto> list = readerService.readFile(TestCsvDto.class, new FileInputStream(file), FilenameUtils.getExtension(file.getName()));
            assertNotNull(list, "Csv file should not be null!");
